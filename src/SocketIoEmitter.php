...
final class SocketIoEmitter
{
    private $client;

    public function connect($host = null, $port = null, $action = 'message', $data = null, $address = '/socket.io/?EIO=2', $transport = 'websocket')
    {
        ...
        $out .= "Host: buslab-socketio.dev.marttech.com.br:443";
